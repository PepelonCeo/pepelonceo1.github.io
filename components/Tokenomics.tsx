...
const TOKENOMICS = [
    { "description": "Initial Dex Offering", "percentage": 45, "color": "teal" },
    { "description": "Will be distributed to the community", "percentage": 25, "color": "green" },
    { "description": "Marketing", "percentage": 10, "color": "orange" },
    { "description": "Team", "percentage": 10, "color": "cyan" },
    { "description": "Development", "percentage": 5, "color": "yellow" },
    { "description": "Liquidity", "percentage": 5, "color": "pink" }
];
    ...
    return (
        <Flex id="tokenomics" mt={{ base: 10, md: 20 }} color="white" px={{ base: 0, md: 20 }} mx={{ base: 0, md: 10 }} justify="space-between"
            ...
            <Flex flex={1} flexDirection="column" justify="center" align={{ base: 'center', md: 'flex-start' }} width={{ base: '100%', md: '80%' }}>
                ...
                <Text mt={4} fontSize="xl" color="gray.400" textAlign="center">PepeplonCeo token fundamentals and distribution.</Text>
                <Text fontSize="xl" color="gray.400" mb={10} textAlign="center">With a total of 1,000,000,000 supply token.</Text>
