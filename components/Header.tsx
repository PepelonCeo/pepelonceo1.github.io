        ...
        <Box id="home">
            <Flex
                ...
                <Flex flex={{ base: 1 }} align="center" justify={{ base: 'center', md: 'start' }}>
                    <Image src="/images/PepelonCeo.png" width={16} height={16} alt="PepelonCeo" />
    ...
    return (
        <Stack direction={'row'} spacing={4} align="center" zIndex={100}>
            ...
            <motion.div ref={rootRef} initial={{ opacity: 0, y: -50 }} animate={controls} custom={NAV_ITEMS.length + 1}>
                <Link href="https://audit.solidgrp.io/audits/PepelonCeo" target="_blank" isExternal style={{ textDecoration: 'none' }}>
                    <Button borderWidth={4} borderRadius={30} py={5} px={8} ml={4} color="white" borderColor="#6e6bbe" display="none" bg="transparent" _hover={{ backgroundColor: '#6e6bbe' }}>Audit</Button>
                </Link>
            </motion.div>
            <motion.div ref={rootRef} initial={{ opacity: 0, y: -50 }} animate={controls} custom={NAV_ITEMS.length + 1}>
                <Link href="https://pepelonceo-organization.gitbook.io/welcome-to-pepelonceo/" target="_blank" isExternal style={{ textDecoration: 'none' }}>
                    <Button bg="#68994a" py={6} px={8} ml={1} color="white" borderRadius={30} _hover={{ backgroundColor: "#27771c"}}>Whitepaper</Button>
                </Link>
            </motion.div>
            {price ?
            <motion.div ref={rootRef} initial={{ opacity: 0, y: -50 }} animate={controls} custom={NAV_ITEMS.length + 1}>
